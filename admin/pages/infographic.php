...
<body>
    ...
    <a href="page/ig_approve.php" class="btn btn-success" >Approve</a>
    <a href="page/ig_reject.php" class="btn btn-danger" >Reject</a>
    </br>
    </br>
    ...
    $no=1;
    $tampil = mysqli_query($conn,"SELECT * FROM tambah WHERE stat_tf = 0");
    ...
    <tr>
                <form action="../config/approve/ig_approve.php" method="post">
                  ...
                  <td>
                    <a href="<?php echo "../../../infographic/assets/pembayaran/1649879240_block-bg.png"?>" download>
                      <img src="<?php echo "../../../infographic/assets/pembayaran/1649879240_block-bg.png".$bukti_pembayaran ?>"
                        style="width: 100px; height: 100px;">
                    </a>
                  </td>

                  <td>
                    <a href="<?php echo "../../infographic/assets/pembayaran/".$bukti_pembayaran ?>" download>
