...
<body>
    ...
    <div class="table-responsive jumbotron">
        <h2>Data Pendaftar Workshop Digimart</h2>
        ...
        <table id="data-example" class="table table-striped table-bordered table-hover" style="width:100%">
            ...
            $no = 1;
            $tampil = mysqli_query($conn, "SELECT * FROM ws_digitalmarketing");
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td><a href="https://asset-a.grid.id/crop/3x0:461x300/360x240/photo/2021/02/05/foto-cover-salah-satu-potret-jb-20210205123524.jpg">
                                klik ini beb
                            </a></td>
                        <td>
