      ...
      <form action="config/registrasi.php" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input name="nohp" type="number" placeholder="Nomor HP" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            <span class="details">Upload Bukti Pembayaran</span>
            <input name="idline" type="file" style="border: 1px solid #ccc;
