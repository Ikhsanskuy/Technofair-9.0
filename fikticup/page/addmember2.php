...
<body   style="background-image: url('../assets/img/regist.png');
  background-size: cover;">
<form action="../config/addmember2.php" method="post" id="msform" enctype="multipart/form-data">
  <!-- progressbar -->
  <!-- fieldsets -->
    <h2 class="fs-title">Data Pribadi</h2>
    <!-- <h3 class="fs-subtitle">This is step 1</h3> -->
    <input type="text" name="npm2" placeholder="NPM" required=""/>
    <input type="text" name="nama2" placeholder="Nama" required=""/>
    <input type="text" name="kelas2" placeholder="Kelas" required=""/>
    <input type="text" name="instansi2" placeholder="Instansi" required=""/>
    <input type="text" name="jurusan2" placeholder="Jurusan" required=""/>
